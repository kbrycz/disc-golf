...
const SaveGameConfirmComponent = ({modalVisible, setModalVisible, saveGame}) => {
        ...
        <Modal
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                  <Text style={styles.modalText}>Are you sure you would like to save the game now?</Text>
                  <Text style={styles.modalText2}>(Can only do once per game!)</Text>
...
export default SaveGameConfirmComponent;